...
#     """
#     update_title_response = sql_functions.update_rows_safe(connection, update_query, (data[0]["title"], data[0]["description"], id,))
#     return True
...
#     """
#     delete_controls = sql_functions.update_rows_safe(connection, clear_controls_query, (id,))
...
#     """
#     sql_functions.update_rows_safe(connection, update_controls_query, (id, id, id,))
#     # for row in data:
#     #    update = """
#     #    insert into ts_killchain_control_mapping(threat_scenario, killchain_stage, control_id) values (%s, %s, %s)
#     #    """
#     #
#     #    sql_functions.update_rows_safe(connection, update, (id, row["killChainStage"], row["controlID"]))
#     return True
...
#     """
#     delete = sql_functions.update_rows_safe(connection, clear_details_query, (id,))

#     for row in data:
#         update_query = """
#         insert into ts_bi_bu_mapping(threat_scenario, business_unit, business_impact) values (%s, %s, %s)
#         """
#         sql_functions.update_rows_safe(connection, update_query, (id, row['businessUnit'], row['businessImpact'],))

#     return True


# def update_threat_vector(connection, id, data):
#     clear_threat_vector_query = """
#     delete from ts_vector_mapping where threat_scenario = %s
#     """
#     delete = sql_functions.update_rows_safe(connection, clear_threat_vector_query, (id,))
#     for row in data:
#         update_query = """
#         insert into ts_vector_mapping(threat_scenario, vector) values (%s, %s)
#         """
#         sql_functions.update_rows_safe(connection, update_query, (id, row['threatVector'],))

#     return True


# def update_threat_actor(connection, id, data):
#     clear_threat_actor_query = """
#     delete from ts_actor_mapping where threat_scenario = %s
#     """
#     delete = sql_functions.update_rows_safe(connection, clear_threat_actor_query, (id,))

#     for row in data:
#         update_query = """
#         insert into ts_actor_mapping(threat_scenario, actor) values (%s, %s)
#         """
#         sql_functions.update_rows_safe(connection, update_query, (id, row['threatActor'],))

#     return True


# def update_techniques(connection, id, data):
#     clear_techniques_query = """
#     delete from ts_killchain_techniques where threat_scenario = %s
#     """
#     delete = sql_functions.update_rows_safe(connection, clear_techniques_query, (id,))
...
#         """
#         sql_functions.update_rows_safe(connection, update_query, (id, row['killChainStage'], row['technique'], row['id'],))

#     return True


# def update_industry(connection, id, data):
#     clear_industry_query = """
#     delete from ts_industry where threat_scenario = %s
#     """
#     delete = sql_functions.update_rows_safe(connection, clear_industry_query, (id,))
    
#     for row in data:
#         update_query = """
#         insert into ts_industry(threat_scenario, industry) values (%s, %s)
#         """
#         sql_functions.update_rows_safe(connection, update_query, (id, row['industry'],))
...
#     delete = sql_functions.update_rows_safe(connection, clear_mapping_query, (id,))

#     update_company_ts_query = """
...
#     """
#     sql_functions.update_rows_safe(connection, update_company_ts_query, (id,))
...
#     delete_row = sql_functions.update_rows(connection, clear_score_query)
    
#     for row in data:
#         update_company_scores_query = """
...
#         sql_functions.update_rows(connection, update_company_scores_query)
#     return True
